    ...
    <div className="bg-white border-b border-gray-200">
      ...
      <div className="px-6 py-4">
        ...
        <div className="px-6">
          ...
          {/* Projects • 5 dropdown and Create Project button, and Search/Filter options */}
          <div className="flex flex-row items-center justify-between py-4">
            {/* Left side: Projects • 5 dropdown and Create Project button */}
            ...
            {/* Right side: Search and Filter options */}
